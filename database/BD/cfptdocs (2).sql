...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 08 juil. 2025 à 21:12
...
('cfptdocs_cache_c4ff231e5ce5284f3fded2e6430d624b', 'i:1;', 1751979053),
('cfptdocs_cache_c4ff231e5ce5284f3fded2e6430d624b:timer', 'i:1751979053;', 1751979053),
('cfptdocs_cache_livewire-rate-limiter:a17961fa74e9275d529f489537f179c05d50c2f3', 'i:1;', 1751971401),
('cfptdocs_cache_livewire-rate-limiter:a17961fa74e9275d529f489537f179c05d50c2f3:timer', 'i:1751971401;', 1751971401);
...
(1, 'Informatique', 'Info1', '2025-07-08 08:43:05', '2025-07-08 08:43:05'),
(2, 'ELectrique', 'Elec1', '2025-07-08 08:44:18', '2025-07-08 08:44:18');
...
CREATE TABLE `fichiers` (
  ...
  `niveau` enum('BTS1','BTS2','BT','BTS','BTI') NOT NULL,
...
INSERT INTO `fichiers` (`id`, `name`, `type`, `niveau`, `annee`, `chemin`, `matiere_id`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 'physique', 'TD', 'BTS1', '', 'fichiers/5ZnFzXiNVMRKTeqiJpvIKfmklj55URmR1RfdcK3F.pdf', 1, 2, '2025-07-08 09:32:25', '2025-07-08 09:32:25'),
(2, 'physique', 'Concours', 'BTS', '', 'fichiers/r8WvyreQBl7Q4meXYoL5541e1t48PFCPsOxFzdH6.pdf', 1, 2, '2025-07-08 09:41:13', '2025-07-08 09:41:13'),
(3, 'physique', 'Concours', 'BTS', '2023-2024', 'fichiers/8octBnte5BrAWGDL0VAq6MtrpxH3z81YB9zBwxQG.pdf', 1, 2, '2025-07-08 10:58:54', '2025-07-08 10:58:54');
...
(1, 'IIR', 1, NULL, '2025-07-08 08:43:30', '2025-07-08 08:43:30'),
(2, 'Dev-Mobile', 1, NULL, '2025-07-08 08:43:47', '2025-07-08 08:43:47'),
(3, 'Auto', 2, NULL, '2025-07-08 08:44:34', '2025-07-08 08:44:48'),
(4, 'Elm', 2, NULL, '2025-07-08 08:45:08', '2025-07-08 08:45:08');
...
(1, 'Programmation', '2025-07-08 08:46:36', '2025-07-08 08:46:36'),
(2, 'Réseau', '2025-07-08 08:47:21', '2025-07-08 08:47:21');
...
(8, '2025_06_03_174547_create_appartenirs_table', 1),
...
(15, '2025_06_23_083653_update_role_column_in_users_table', 1),
(16, '2025_07_08_125541_add_annee_to_fichiers_table', 2);
...
('WLSD5nZNA8yQzjELcgJK5xFlaDQCAwFeCBjuqcv4', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiTVVRaWlmSTk3aksxSDJyQTI1cGY5dGd6VW1DQ2NnMzZvN3dVNnJ1YiI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzA6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9jb25jb3VycyI7fX0=', 1751979570);
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `specialiste`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `current_team_id`, `profile_photo_path`, `created_at`, `updated_at`, `role`, `matricule`, `niveau`, `filiere_id`) VALUES
(1, 'Admin CFPT', 'admin@cfptdocs.com', NULL, 'electronique', '$2y$12$OxevnJAtnTfpvb9Bnmmc9eTpuOnLNdxU0arq99/WdqOIFMVjWR09O', NULL, NULL, NULL, NULL, NULL, NULL, '2025-07-08 08:38:36', '2025-07-08 08:38:36', 'admin', NULL, NULL, NULL),
(2, 'Omar Diouf', 'omardiouf826@gmail.com', NULL, 'programmation', '$2y$12$iHTaxeDLNOj3QmmvxJ.Uae2zKNPTOZ/6asq/el0WxzCIxAdiVnb1W', NULL, NULL, NULL, NULL, NULL, NULL, '2025-07-08 09:22:58', '2025-07-08 09:22:58', 'professeur', NULL, NULL, NULL);
